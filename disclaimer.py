...
class DisclaimerDialog(QMessageBox):
    def __init__(self, parent=None):
        ...
        <p class="normal"><b>Запрещается использовать программу для:</b></p>
        <ul>
            <li>Пропаганды взлома или несанкционированного доступа</li>
            <li>Пропаганды нарушения конфиденциальность других лиц</li>
            <li>Пропаганды наносить ущерба компьютерным системам</li>
            <li>Пропаганды распространения вредоносного программного обеспечения</li>
        </ul>

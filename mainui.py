...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox.setGeometry(QtCore.QRect(11, 480, 317, 20))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(430, 510, 311, 28))
        self.pushButton_2.setObjectName("pushButton_2")
        self.checkBox_2 = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.checkBox_2.setGeometry(QtCore.QRect(430, 480, 301, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "Показать гайд по уязвимости"))
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Сканировать проект"))
        self.checkBox_2.setText(
            _translate("MainWindow", "Сохранить рузультаты сканирования")
        )
